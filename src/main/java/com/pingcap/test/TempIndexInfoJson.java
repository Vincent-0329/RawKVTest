...
public class TempIndexInfoJson  implements TestDate {
    static final Logger logger = LoggerFactory.getLogger("TempIndexInfoJson");
    ...
    static {
        try {
            ...
            nums = Long.valueOf(properties.getProperty("TempIndexInfoJson.nums", "1000000"));
            startNums = Long.valueOf(properties.getProperty("TempIndexInfoJson.startNums", "1"));
            eachSlices = Long.valueOf(properties.getProperty("TempIndexInfoJson.eachSlices", "100000"));
            wrongData = Integer.parseInt(properties.getProperty("TempIndexInfoJson.wrongData", "10000"));
            filePathWithOutSuffix = properties.getProperty("TempIndexInfoJson.filePathWithOutSuffix", "/tempIndex");
