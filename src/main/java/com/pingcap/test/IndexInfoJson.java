...
public class IndexInfoJson  implements TestDate {
    static final Logger logger = LoggerFactory.getLogger("IndexInfoJson");
    ...
    static {
        try {
            ...
            startNums = Long.valueOf(properties.getProperty("IndexInfoJson.startNums", "1000000"));
