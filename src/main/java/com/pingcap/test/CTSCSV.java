...
public class CTSCSV implements TestDate {

    static final Logger logger = LoggerFactory.getLogger("CTSCSV");
    ...
    static {
        try {
            ...
            InputStream input = CTSCSV.class.getClassLoader().getResourceAsStream("Test.properties");
            properties.load(input);
            nums = Long.valueOf(properties.getProperty("CTSCSV.nums", "1000000"));
            startNums = Long.valueOf(properties.getProperty("CTSCSV.startNums", "1000000"));
            eachSlices = Long.valueOf(properties.getProperty("CTSCSV.eachSlices", "100000"));
            wrongData = Integer.parseInt(properties.getProperty("CTSCSV.wrongData", "10000"));
            filePathWithOutSuffix = properties.getProperty("CTSCSV.filePathWithOutSuffix", "/tempIndex");
    ...
    private static class ParallelExecuteCreateDataTask extends RecursiveTask<Long> {
        ...
        protected Long compute() {
            if (endValue - startValue < CTSCSV.eachSlices) {
            ...
            ParallelExecuteCreateDataTask subTask1 = new ParallelExecuteCreateDataTask(startValue, (startValue + CTSCSV.eachSlices - 1));
            subTask1.fork();
            ParallelExecuteCreateDataTask subTask2 = new ParallelExecuteCreateDataTask((startValue + CTSCSV.eachSlices), endValue);
            subTask2.fork();
            return startValue;
        }
    }
